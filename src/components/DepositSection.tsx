...
const depositPlans = [
  {
    ...
    maturityInterest: 9.5,
  },
  {
    period: "1 Year",
    months: 12,
    monthlyInterest: 9.5,
    maturityInterest: 10.0,
  },
  {
    period: "2 Years",
    months: 24,
    monthlyInterest: 10.0,
    maturityInterest: 10.5,
  },
  {
    period: "3 Years",
    months: 36,
    monthlyInterest: 10.5,
    maturityInterest: 11.0,
  },
  {
    period: "4 Years",
    months: 48,
    monthlyInterest: 11.0,
    maturityInterest: 11.6,
  },
  {
    period: "5 Years",
    months: 60,
    monthlyInterest: 11.5,
    maturityInterest: 12.2,
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Earn up to <strong>10% annual interest</strong> on your deposits
            with our flexible agricultural development savings plans.
          </p>
        </motion.div>
            ...
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
              ...
              <div className="px-6 py-4 bg-amber-50 border-t border-amber-100">
                <div className="flex items-center gap-2 text-amber-700 text-xs">
                  <FaInfoCircle />
                  Interest rates are per annum. Subject to change. Terms &
                  conditions apply.
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="bg-gradient-to-br from-green-700 to-emerald-600 rounded-3xl p-6 text-white">
              ...
              <div className="text-white/70 text-sm mb-4">
                On fixed deposits of 1 year and above
              </div>
              <div className="bg-white/20 rounded-2xl p-4">
                ...
                <div className="text-xs text-white/80 space-y-1">
                  ...
                  <div>Interest: Rs. 12,200</div>
                  <div className="font-bold">Maturity: Rs. 112,200</div>
                </div>
              </div>
            </div>
