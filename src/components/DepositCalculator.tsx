        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          >
            <h3
              ...
              style={{ color: INK }}
            >
              <Calculator strokeWidth={1.75} style={{ color: STEEL }} />
            ...
            <div className="mb-8">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (!isNaN(raw)) setAmount(Math.max(5000, Math.min(5000000, raw)));
                }}
              ...
              <div className="grid grid-cols-2 gap-3">
                {isMonthly && monthlyInterestAmount && (
                  <div
                    className="p-4"
                    style={{
                      backgroundColor: `${STEEL}0D`,
                      border: `1px solid ${STEEL}33`,
                    }}
                  >
                    <div className="text-xs mb-1" style={{ color: `${INK}80` }}>
                      {t.calculator.monthlyInterest}
                    </div>
                    <div
                ...
                <div
                  className="p-4"
                  style={{
                    background: `linear-gradient(115deg, ${STEEL}, ${INDIGO})`,
                    gridColumn:
                      isMonthly && monthlyInterestAmount
                        ? "auto"
                        : "span 2 / span 2",
          ...
          >
            ...
            <div
              className="mt-6 p-4"
              style={{
                backgroundColor: `${JADE}0D`,
                border: `1px solid ${JADE}33`,
              }}
            >
              <div className="text-center">
                <div className="text-sm mb-1" style={{ color: `${INK}80` }}>
                  {t.calculator.growsFrom}
                </div>
                ...
                >
                  ...
                  {t.calculator.totalReturn} {months} {t.calculator.months}
                </div>
              </div>
            </div>
          </motion.div>
