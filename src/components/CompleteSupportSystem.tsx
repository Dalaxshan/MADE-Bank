...
const stages = [
  ...
  { step: 3, icon: Sprout, title: 'Cultivation', desc: 'Farm with technical guidance from MADE Co-op officers' },
  { step: 4, icon: Warehouse, title: 'Harvest', desc: 'Bumper harvest achieved with proper farming practices' },
  { step: 5, icon: Handshake, title: 'Guaranteed Purchase', desc: 'MADE Co-op buys 100% of your harvest at fair prices' },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: `${PAPER}B3` }}>
            ...
            MADE Co-op is with you at <strong style={{ color: PAPER }}>every single step</strong>.
          </p>
        </motion.div>
